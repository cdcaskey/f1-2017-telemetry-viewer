...
namespace TelemetryViewer.Server.Models
{
    public static class UdpModels
    {
        public struct UDPPacket
        {
            ...
            public float m_session_time_left;           // time left in session in seconds 
            public byte m_rev_lights_percent;           // rev lights indicator (percentage)
            public byte m_is_spectating;                // whether the player is spectating
            public byte m_spectator_car_index;          // index of the car being spectated
            ...
            public float m_roll; 
            public float m_x_local_velocity;            // velocity in local space
            public float m_y_local_velocity;            // velocity in local space
            public float m_z_local_velocity;            // velocity in local space
            public float[] m_susp_acceleration;         // RL, RR, FL, FR
            public float m_ang_acc_x;                   // angular acceleration x-component
            public float m_ang_acc_y;                   // angular acceleration y-component
            public float m_ang_acc_z;                   // angular acceleration z-component
